...
namespace Dropecho {
  public class AnimationDirectionContext {
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/0 Deg (Forward)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/90 Deg (Right)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/-90 Deg (Left)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/45 Deg (Forward + Right)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/-45 Deg (Forward + Left)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/135 Deg (Backwards + Right)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/-135 Deg (Backwards + Left)", false, 10)]
    ...
    [UnityEditor.MenuItem("CONTEXT/AnimationClip/Direction/180 Deg (Backwards)", false, 10)]
